...
import { RichText, BlockControls, InspectorControls, __experimentalLinkControl as LinkControl, getColorObjectByColorValue } from "@wordpress/block-editor"
...
registerBlockType("ourblocktheme/genericbutton", {
  ...
  attributes: {
    ...
    linkObject: { type: "object", default: { uri: "" } },
